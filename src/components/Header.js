    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-200 bg-white/95 shadow-sm backdrop-blur">
      ...
      >
        ...
        <div className="flex items-center gap-6 text-sm font-medium text-zinc-600">
          <Link
            href="/"
            className="flex items-center gap-2 transition-colors hover:text-zinc-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 rounded"
          >
